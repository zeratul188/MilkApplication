...
public class DeliveryTuesdayDBAdapter {
    ...
    private static final String DATABASE_CREATE = "create table DELIVERY_TUESDAY (_id integer primary key, "
            +"ADDRESS text not null, PASSWORD text, "
            +"MILK text, NUMBER int);";

    private static final String DATABASE_NAME = "MILKDELIVERY_TUESDAY";
    private static final String DATABASE_TABLE = "DELIVERY_TUESDAY";
    ...
    public DeliveryTuesdayDBAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS DELIVERY_TUESDAY");
            onCreate(db);
        }
    }

    public DeliveryTuesdayDBAdapter open() throws SQLException {
