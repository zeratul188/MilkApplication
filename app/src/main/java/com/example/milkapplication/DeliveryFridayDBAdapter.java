...
public class DeliveryFridayDBAdapter {
    ...
    private static final String DATABASE_CREATE = "create table DELIVERY_FRIDAY (_id integer primary key, "
            +"ADDRESS text not null, PASSWORD text, "
            +"MILK text, NUMBER int);";

    private static final String DATABASE_NAME = "MILKDELIVERY_FRIDAY";
    private static final String DATABASE_TABLE = "DELIVERY_FRIDAY";
    ...
    public DeliveryFridayDBAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS DELIVERY_FRIDAY");
            onCreate(db);
        }
    }

    public DeliveryFridayDBAdapter open() throws SQLException {
