...
public class DeliveryThursdayDBAdapter {
    ...
    private static final String DATABASE_CREATE = "create table DELIVERY_THURSDAY (_id integer primary key, "
            +"ADDRESS text not null, PASSWORD text, "
            +"MILK text, NUMBER int);";

    private static final String DATABASE_NAME = "MILKDELIVERY_THURSDAY";
    private static final String DATABASE_TABLE = "DELIVERY_THURSDAY";
    ...
    public DeliveryThursdayDBAdapter(Context mCtx) {
        this.mCtx = mCtx;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            db.execSQL("DROP TABLE IF EXISTS DELIVERY_THURSDAY");
            onCreate(db);
        }
    }

    public DeliveryThursdayDBAdapter open() throws SQLException {
